...
const DBMaster: MongoClient = new MongoClient(
  process.env.PROD_DATABASE_URL || ""
);
const DBStaging: MongoClient = new MongoClient(
  process.env.RC_DATABASE_URL || ""
);
const DBDevelopment: MongoClient = new MongoClient(
  process.env.WIP_DATABASE_URL || ""
);
